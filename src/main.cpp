...
namespace mbp
{
	...
	public:
		find_multibase_primes()
		{
			...
			count_passes(a = ps15 = ps3 = b = c = d = e = f = g = h = i = 0);
			count_passes(j = k = l = m = n = o = p = q = passes = pc_hash = 0);
		}
	...
	private:
		...
		count_passes(size_t a, ps15, ps3, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, passes, pc_hash = 0);
	};
