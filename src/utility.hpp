...
template<size_t n_bits>
using narrowest_uint_for_n_bits = decltype(util_hpp_detail::narrowest_uint_for_n_bits<n_bits>());

template<uint64_t val>
using narrowest_uint_for_val = decltype(util_hpp_detail::narrowest_uint_for_val<val>());
