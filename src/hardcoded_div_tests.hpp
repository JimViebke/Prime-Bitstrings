...
namespace mbp
{
	namespace detail
	{
		...
		consteval std::array<uint8_t, 32> build_3rem_shuffle_lookup()
		{
			...
			{
				if (i & 0b001) lookup[i] += pow_mod(base, 0, prime);
				if (i & 0b010) lookup[i] += pow_mod(base, 1, prime);
				if (i & 0b100) lookup[i] += pow_mod(base, 2, prime);
				lookup[i + 16] = lookup[i]; // duplicate into upper lane
			}
			return lookup;
		}
													   ...
													   const size_t* const candidates_end)
	{
		...
		if constexpr (on_fast_path)
		{
			...
			b5m13_urem += upc_1 * pow_mod(5, 1, 13);
			b8m13_urem += upc_1 * pow_mod(8, 1, 13);
			b4m17_urem += upc_1 * pow_mod(4, 1, 17);
			const size_t upc_2 = pop_count(number_upper & (bitmask << 2));
			b5m13_urem += upc_2 * pow_mod(5, 2, 13);
			b8m13_urem += upc_2 * pow_mod(8, 2, 13);
			b4m17_urem += upc_2 * pow_mod(4, 2, 17);
			const size_t upc_3 = pop_count(number_upper & (bitmask << 3));
			b5m13_urem += upc_3 * pow_mod(5, 3, 13);
			b8m13_urem += upc_3 * pow_mod(8, 3, 13);
			b4m17_urem += upc_3 * pow_mod(4, 3, 17);
		...
		for (; input < candidates_end; ++input)
		{
			...
			*output = number;
			...
			b5m13_rem += pc_1 * pow_mod(5, 1, 13);
			b8m13_rem += pc_1 * pow_mod(8, 1, 13);
			b4m17_rem += pc_1 * pow_mod(4, 1, 17);

			const size_t pc_2 = pop_count(number & (bitmask << 2));
			b5m13_rem += pc_2 * pow_mod(5, 2, 13);
			b8m13_rem += pc_2 * pow_mod(8, 2, 13);
			b4m17_rem += pc_2 * pow_mod(4, 2, 17);

			const size_t pc_3 = pop_count(number & (bitmask << 3));
			b5m13_rem += pc_3 * pow_mod(5, 3, 13);
			b8m13_rem += pc_3 * pow_mod(8, 3, 13);
			b4m17_rem += pc_3 * pow_mod(4, 3, 17);
															...
															const size_t* const candidates_end)
	{
		...
		if constexpr (on_fast_path)
		{
			...
			b8m13_urem += upc_1 * pow_mod(8, 1, 13);
			b4m17_urem += upc_1 * pow_mod(4, 1, 17);
			b13m17_urem += upc_1 * pow_mod(13, 1, 17);
			const size_t upc_2 = pop_count(number_upper & (bitmask << 2));
			b5m13_urem += upc_2 * pow_mod(5, 2, 13);
			b8m13_urem += upc_2 * pow_mod(8, 2, 13);
			b4m17_urem += upc_2 * pow_mod(4, 2, 17);
			b13m17_urem += upc_2 * pow_mod(13, 2, 17);
			const size_t upc_3 = pop_count(number_upper & (bitmask << 3));
			b5m13_urem += upc_3 * pow_mod(5, 3, 13);
			b8m13_urem += upc_3 * pow_mod(8, 3, 13);
			b4m17_urem += upc_3 * pow_mod(4, 3, 17);
			b13m17_urem += upc_3 * pow_mod(13, 3, 17);
			const uint8_t* const indivisible_by_13_ptr_b5 = indivisible_by[get_prime_index<13>::idx].data() + b5m13_urem;
			const uint8_t* const indivisible_by_13_ptr_b8 = indivisible_by[get_prime_index<13>::idx].data() + b8m13_urem;
		...
		for (; input < candidates_end; ++input)
		{
			...
			*output = number;
			...
			b8m13_rem += pc_1 * pow_mod(8, 1, 13);
			b4m17_rem += pc_1 * pow_mod(4, 1, 17);
			b13m17_rem += pc_1 * pow_mod(13, 1, 17);

			const size_t pc_2 = pop_count(number & (bitmask << 2));
			b5m13_rem += pc_2 * pow_mod(5, 2, 13);
			b8m13_rem += pc_2 * pow_mod(8, 2, 13);
			b4m17_rem += pc_2 * pow_mod(4, 2, 17);
			b13m17_rem += pc_2 * pow_mod(13, 2, 17);

			const size_t pc_3 = pop_count(number & (bitmask << 3));
			b5m13_rem += pc_3 * pow_mod(5, 3, 13);
			b8m13_rem += pc_3 * pow_mod(8, 3, 13);
			b4m17_rem += pc_3 * pow_mod(4, 3, 17);
			b13m17_rem += pc_3 * pow_mod(13, 3, 17);
														...
														const size_t* const candidates_end)
	{
		...
		if constexpr (on_fast_path)
		{
			...
			upper_sum_b3m13 += pc_1 * pow_mod(3, 1, 13);
			upper_sum_b9m13 += pc_1 * pow_mod(9, 1, 13);
			const size_t pc_2 = pop_count(upper_bits & (bitmask << 2));
			upper_sum_b3m13 += pc_2 * pow_mod(3, 2, 13);
			upper_sum_b9m13 += pc_2 * pow_mod(9, 2, 13);
		...
		for (; input < candidates_end; )
		{
			...
			const size_t pc_1 = pop_count(number & (bitmask << 1));
			b3_m13_rem += pc_1 * pow_mod(3, 1, 13);
			b9_m13_rem += pc_1 * pow_mod(9, 1, 13);

			const size_t pc_2 = pop_count(number & (bitmask << 2));
			b3_m13_rem += pc_2 * pow_mod(3, 2, 13);
			b9_m13_rem += pc_2 * pow_mod(9, 2, 13);
													   ...
													   const size_t* const candidates_end)
	{
		...
		if constexpr (on_fast_path)
		{
			...
			size_t sum_3 = pc_0;
			const size_t pc_1 = pop_count(upper_bits & (bitmask << 1));
			sum_0 += pc_1 * pow_mod(3, 1, 11);
			sum_1 += pc_1 * pow_mod(4, 1, 11);
			sum_2 += pc_1 * pow_mod(5, 1, 11);
			sum_3 += pc_1 * pow_mod(9, 1, 11);
			const size_t pc_2 = pop_count(upper_bits & (bitmask << 2));
			sum_0 += pc_2 * pow_mod(3, 2, 11);
			sum_1 += pc_2 * pow_mod(4, 2, 11);
			sum_2 += pc_2 * pow_mod(5, 2, 11);
			sum_3 += pc_2 * pow_mod(9, 2, 11);
			const size_t pc_3 = pop_count(upper_bits & (bitmask << 3));
			sum_0 += pc_3 * pow_mod(3, 3, 11);
			sum_1 += pc_3 * pow_mod(4, 3, 11);
			sum_2 += pc_3 * pow_mod(5, 3, 11);
			sum_3 += pc_3 * pow_mod(9, 3, 11);
			const size_t pc_4 = pop_count(upper_bits & (bitmask << 4));
			sum_0 += pc_4 * pow_mod(3, 4, 11);
			sum_1 += pc_4 * pow_mod(4, 4, 11);
			sum_2 += pc_4 * pow_mod(5, 4, 11);
			sum_3 += pc_4 * pow_mod(9, 4, 11);
		...
		for (; input < candidates_end; )
		{
			...
			size_t b9_rem = pc_0;
			const size_t pc_1 = pop_count(number & (bitmask << 1));
			b3_rem += pc_1 * pow_mod(3, 1, 11);
			b4_rem += pc_1 * pow_mod(4, 1, 11);
			b5_rem += pc_1 * pow_mod(5, 1, 11);
			b9_rem += pc_1 * pow_mod(9, 1, 11);
			const size_t pc_2 = pop_count(number & (bitmask << 2));
			b3_rem += pc_2 * pow_mod(3, 2, 11);
			b4_rem += pc_2 * pow_mod(4, 2, 11);
			b5_rem += pc_2 * pow_mod(5, 2, 11);
			b9_rem += pc_2 * pow_mod(9, 2, 11);
			const size_t pc_3 = pop_count(number & (bitmask << 3));
			b3_rem += pc_3 * pow_mod(3, 3, 11);
			b4_rem += pc_3 * pow_mod(4, 3, 11);
			b5_rem += pc_3 * pow_mod(5, 3, 11);
			b9_rem += pc_3 * pow_mod(9, 3, 11);
			const size_t pc_4 = pop_count(number & (bitmask << 4));
			b3_rem += pc_4 * pow_mod(3, 4, 11);
			b4_rem += pc_4 * pow_mod(4, 4, 11);
			b5_rem += pc_4 * pow_mod(5, 4, 11);
			b9_rem += pc_4 * pow_mod(9, 4, 11);
	...
	static const std::array<uint8_t, 16> out_advance = [] {
		std::array<uint8_t, 16> lookup{};
		for (size_t i = 0; i < 16; ++i)
			lookup[i] = uint8_t(pop_count(i) * 8);
		return lookup;
	}();
													...
													const size_t* const candidates_end)
	{
		...
		if constexpr (on_fast_path)
		{
			...
			// run vector instructions one iteration ahead
			{
				...
				const uint256_t b8 = _mm256_i32gather_epi32(indivisible_b8, sums_04152637_b8m17, 1);
				const uint256_t b9 = _mm256_i32gather_epi32(indivisible_b9, sums_04152637_b9m17, 1);
				uint256_t ind_04152637 = _mm256_and_si256(b8, b9);
				ind_04152637 = _mm256_slli_epi32(ind_04152637, 31 - 3); // shift bits from idx 3 to idx 31
				mask_0123 = _mm256_movemask_pd(_mm256_castsi256_pd(_mm256_slli_si256(ind_04152637, 4)));
				mask_4567 = _mm256_movemask_pd(_mm256_castsi256_pd(ind_04152637));
			}
			...
			for (; input < candidates_end_rounded; )
			{
				...
				// pack chunks
				const uint128_t permute_mask_0123 = _mm_cvtsi64_si128(permute_masks[mask_0123]);
				const uint128_t permute_mask_4567 = _mm_cvtsi64_si128(permute_masks[mask_4567]);
				const uint256_t packed_0123 = _mm256_permutevar8x32_epi32(*(uint256_t*)(input + 0), _mm256_cvtepu8_epi32(permute_mask_0123));
				const uint256_t packed_4567 = _mm256_permutevar8x32_epi32(*(uint256_t*)(input + 4), _mm256_cvtepu8_epi32(permute_mask_4567));
				input += 8;

				_mm256_storeu_si256((uint256_t*)output, packed_0123); // store 0-4 candidates
				output = (uint64_t*)(((uint8_t*)output) + out_advance[mask_0123]); // advance 0-4 elements

				_mm256_storeu_si256((uint256_t*)output, packed_4567);
				output = (uint64_t*)(((uint8_t*)output) + out_advance[mask_4567]);
													   ...
													   const size_t* const candidates_end)
	{
		...
		if constexpr (on_fast_path)
		{
			...
			size_t sum_3 = pc_0;
			const size_t pc_1 = pop_count(upper_bits & (bitmask << 1));
			sum_0 += pc_1 * pow_mod(4, 1, 19);
			sum_1 += pc_1 * pow_mod(5, 1, 19);
			sum_2 += pc_1 * pow_mod(6, 1, 19);
			sum_3 += pc_1 * pow_mod(9, 1, 19);
			const size_t pc_2 = pop_count(upper_bits & (bitmask << 2));
			sum_0 += pc_2 * pow_mod(4, 2, 19);
			sum_1 += pc_2 * pow_mod(5, 2, 19);
			sum_2 += pc_2 * pow_mod(6, 2, 19);
			sum_3 += pc_2 * pow_mod(9, 2, 19);
			const size_t pc_3 = pop_count(upper_bits & (bitmask << 3));
			sum_0 += pc_3 * pow_mod(4, 3, 19);
			sum_1 += pc_3 * pow_mod(5, 3, 19);
			sum_2 += pc_3 * pow_mod(6, 3, 19);
			sum_3 += pc_3 * pow_mod(9, 3, 19);
			const size_t pc_4 = pop_count(upper_bits & (bitmask << 4));
			sum_0 += pc_4 * pow_mod(4, 4, 19);
			sum_1 += pc_4 * pow_mod(5, 4, 19);
			sum_2 += pc_4 * pow_mod(6, 4, 19);
			sum_3 += pc_4 * pow_mod(9, 4, 19);
			const size_t pc_5 = pop_count(upper_bits & (bitmask << 5));
			sum_0 += pc_5 * pow_mod(4, 5, 19);
			sum_1 += pc_5 * pow_mod(5, 5, 19);
			sum_2 += pc_5 * pow_mod(6, 5, 19);
			sum_3 += pc_5 * pow_mod(9, 5, 19);
			const size_t pc_6 = pop_count(upper_bits & (bitmask << 6));
			sum_0 += pc_6 * pow_mod(4, 6, 19);
			sum_1 += pc_6 * pow_mod(5, 6, 19);
			sum_2 += pc_6 * pow_mod(6, 6, 19);
			sum_3 += pc_6 * pow_mod(9, 6, 19);
			const size_t pc_7 = pop_count(upper_bits & (bitmask << 7));
			sum_0 += pc_7 * pow_mod(4, 7, 19);
			sum_1 += pc_7 * pow_mod(5, 7, 19);
			sum_2 += pc_7 * pow_mod(6, 7, 19);
			sum_3 += pc_7 * pow_mod(9, 7, 19);
			const size_t pc_8 = pop_count(upper_bits & (bitmask << 8));
			sum_0 += pc_8 * pow_mod(4, 8, 19);
			sum_1 += pc_8 * pow_mod(5, 8, 19);
			sum_2 += pc_8 * pow_mod(6, 8, 19);
			sum_3 += pc_8 * pow_mod(9, 8, 19);
		...
		for (; input < candidates_end; )
		{
			...
			size_t b9_rem = pc_0;
			const size_t pc_1 = pop_count(number & (bitmask << 1));
			b4_rem += pc_1 * pow_mod(4, 1, 19);
			b5_rem += pc_1 * pow_mod(5, 1, 19);
			b6_rem += pc_1 * pow_mod(6, 1, 19);
			b9_rem += pc_1 * pow_mod(9, 1, 19);
			const size_t pc_2 = pop_count(number & (bitmask << 2));
			b4_rem += pc_2 * pow_mod(4, 2, 19);
			b5_rem += pc_2 * pow_mod(5, 2, 19);
			b6_rem += pc_2 * pow_mod(6, 2, 19);
			b9_rem += pc_2 * pow_mod(9, 2, 19);
			const size_t pc_3 = pop_count(number & (bitmask << 3));
			b4_rem += pc_3 * pow_mod(4, 3, 19);
			b5_rem += pc_3 * pow_mod(5, 3, 19);
			b6_rem += pc_3 * pow_mod(6, 3, 19);
			b9_rem += pc_3 * pow_mod(9, 3, 19);
			const size_t pc_4 = pop_count(number & (bitmask << 4));
			b4_rem += pc_4 * pow_mod(4, 4, 19);
			b5_rem += pc_4 * pow_mod(5, 4, 19);
			b6_rem += pc_4 * pow_mod(6, 4, 19);
			b9_rem += pc_4 * pow_mod(9, 4, 19);
			const size_t pc_5 = pop_count(number & (bitmask << 5));
			b4_rem += pc_5 * pow_mod(4, 5, 19);
			b5_rem += pc_5 * pow_mod(5, 5, 19);
			b6_rem += pc_5 * pow_mod(6, 5, 19);
			b9_rem += pc_5 * pow_mod(9, 5, 19);
			const size_t pc_6 = pop_count(number & (bitmask << 6));
			b4_rem += pc_6 * pow_mod(4, 6, 19);
			b5_rem += pc_6 * pow_mod(5, 6, 19);
			b6_rem += pc_6 * pow_mod(6, 6, 19);
			b9_rem += pc_6 * pow_mod(9, 6, 19);
			const size_t pc_7 = pop_count(number & (bitmask << 7));
			b4_rem += pc_7 * pow_mod(4, 7, 19);
			b5_rem += pc_7 * pow_mod(5, 7, 19);
			b6_rem += pc_7 * pow_mod(6, 7, 19);
			b9_rem += pc_7 * pow_mod(9, 7, 19);
			const size_t pc_8 = pop_count(number & (bitmask << 8));
			b4_rem += pc_8 * pow_mod(4, 8, 19);
			b5_rem += pc_8 * pow_mod(5, 8, 19);
			b6_rem += pc_8 * pow_mod(6, 8, 19);
			b9_rem += pc_8 * pow_mod(9, 8, 19);
														  ...
														  const size_t* const candidates_end)
	{
		...
		if constexpr (on_fast_path)
		{
			...
			const size_t pc_1 = pop_count(upper_bits & (bitmask << 1));
			upper_sum_0 += pc_1 * pow_mod(8, 1, 19);
			upper_sum_1 += pc_1 * pow_mod(12, 1, 19);
			const size_t pc_2 = pop_count(upper_bits & (bitmask << 2));
			upper_sum_0 += pc_2 * pow_mod(8, 2, 19);
			upper_sum_1 += pc_2 * pow_mod(12, 2, 19);
			const size_t pc_3 = pop_count(upper_bits & (bitmask << 3));
			upper_sum_0 += pc_3 * pow_mod(8, 3, 19);
			upper_sum_1 += pc_3 * pow_mod(12, 3, 19);
			const size_t pc_4 = pop_count(upper_bits & (bitmask << 4));
			upper_sum_0 += pc_4 * pow_mod(8, 4, 19);
			upper_sum_1 += pc_4 * pow_mod(12, 4, 19);
			const size_t pc_5 = pop_count(upper_bits & (bitmask << 5));
			upper_sum_0 += pc_5 * pow_mod(8, 5, 19);
			upper_sum_1 += pc_5 * pow_mod(12, 5, 19);
		...
		for (; input != candidates_end; ++input)
		{
			...
			*output = number; // always write
			...
			size_t b12_sum = pc_0;
			const size_t pc_1 = pop_count(number & (bitmask << 1));
			b8_sum += pc_1 * pow_mod(8, 1, 19);
			b12_sum += pc_1 * pow_mod(12, 1, 19);
			const size_t pc_2 = pop_count(number & (bitmask << 2));
			b8_sum += pc_2 * pow_mod(8, 2, 19);
			b12_sum += pc_2 * pow_mod(12, 2, 19);
			const size_t pc_3 = pop_count(number & (bitmask << 3));
			b8_sum += pc_3 * pow_mod(8, 3, 19);
			b12_sum += pc_3 * pow_mod(12, 3, 19);
			const size_t pc_4 = pop_count(number & (bitmask << 4));
			b8_sum += pc_4 * pow_mod(8, 4, 19);
			b12_sum += pc_4 * pow_mod(12, 4, 19);
			const size_t pc_5 = pop_count(number & (bitmask << 5));
			b8_sum += pc_5 * pow_mod(8, 5, 19);
			b12_sum += pc_5 * pow_mod(12, 5, 19);
															  ...
															  const uint64_t* const candidates_end)
	{
		...
		if constexpr (on_fast_path)
		{
			...
			const size_t pc_1 = pop_count(upper_bits & (bitmask << 1));
			upper_sum_b7m19 += pc_1 * pow_mod(7, 1, 19);
			upper_sum_b11m19 += pc_1 * pow_mod(11, 1, 19);
			const size_t pc_2 = pop_count(upper_bits & (bitmask << 2));
			upper_sum_b7m19 += pc_2 * pow_mod(7, 2, 19);
			upper_sum_b11m19 += pc_2 * pow_mod(11, 2, 19);
		...
		for (; input < candidates_end; )
		{
			...
			*output = number; // always write
			...
			const size_t pc_1 = pop_count(number & (bitmask << 1));
			sum_b7 += pc_1 * pow_mod(7, 1, 19);
			sum_b11 += pc_1 * pow_mod(11, 1, 19);

			const size_t pc_2 = pop_count(number & (bitmask << 2));
			sum_b7 += pc_2 * pow_mod(7, 2, 19);
			sum_b11 += pc_2 * pow_mod(11, 2, 19);
