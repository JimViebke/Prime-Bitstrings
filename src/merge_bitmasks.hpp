...
namespace mbp
{
	...
	inline const sieve_container static_sieve{ prime_sieve::generate_static_sieve() };

	std::vector<bit_array<pow_2_16>> build_popcounts_lookup();
	// [outer popcount 0-46][bitstring inner bits]
	inline const std::vector<bit_array<pow_2_16>> pc_lookup{ build_popcounts_lookup() };

	std::vector<bit_array<pow_2_16>> build_gcd_lookup();
	// [outer alternating bitsum 0-47][bitstring inner bits]
	inline const std::vector<bit_array<pow_2_16>> gcd_lookup{ build_gcd_lookup() };
	...
	inline const std::unique_ptr<std::array<bit_array<pow_2_16>, 5>> b3m5_lookup{
		build_bitmask_for<3, 5>() };
	inline const std::unique_ptr<std::array<bit_array<pow_2_16>, 7>> b3m7_lookup{
		build_bitmask_for<3, 7>() };
	inline const std::unique_ptr<std::array<bit_array<pow_2_16>, 13>> b3m13_lookup{
		build_bitmask_for<3, 13>() };
	inline const std::unique_ptr<std::array<bit_array<pow_2_16>, 7>> b4m7_lookup{
		build_bitmask_for<4, 7>() };
	inline const std::unique_ptr<std::array<bit_array<pow_2_16>, 13>> b4m13_lookup{
		build_bitmask_for<4, 13>() };
	inline const std::unique_ptr<std::array<bit_array<pow_2_16>, 17>> b4m17_lookup{
		build_bitmask_for<4, 17>() };
	inline const std::unique_ptr<std::array<bit_array<pow_2_16>, 7>> b5m7_lookup{
		build_bitmask_for<5, 7>() };
	inline const std::unique_ptr<std::array<bit_array<pow_2_16>, 13>> b5m13_lookup{
		build_bitmask_for<5, 13>() };
	inline const std::unique_ptr<std::array<bit_array<pow_2_16>, 13>> b8m13_lookup{
		build_bitmask_for<8, 13>() };
	inline const std::unique_ptr<std::array<bit_array<pow_2_16>, 13>> b9m13_lookup{
		build_bitmask_for<9, 13>() };
	inline const std::unique_ptr<std::array<bit_array<pow_2_16>, 13>> b10m13_lookup{
		build_bitmask_for<10, 13>() };
	inline const std::unique_ptr<std::array<bit_array<pow_2_16>, 17>> b13m17_lookup{
		build_bitmask_for<13, 17>() };
	inline const std::unique_ptr<std::array<bit_array<pow_2_16>, 11>> b3m11_lookup{
		build_bitmask_for<3, 11>() };
	inline const std::unique_ptr<std::array<bit_array<pow_2_16>, 11>> b4m11_lookup{
		build_bitmask_for<4, 11>() };
	inline const std::unique_ptr<std::array<bit_array<pow_2_16>, 11>> b5m11_lookup{
		build_bitmask_for<5, 11>() };
	inline const std::unique_ptr<std::array<bit_array<pow_2_16>, 11>> b9m11_lookup{
		build_bitmask_for<9, 11>() };
	inline const std::unique_ptr<std::array<bit_array<pow_2_16>, 11>> b6m11_lookup{
		build_bitmask_for<6, 11>() };
	inline const std::unique_ptr<std::array<bit_array<pow_2_16>, 11>> b7m11_lookup{
		build_bitmask_for<7, 11>() };
	inline const std::unique_ptr<std::array<bit_array<pow_2_16>, 11>> b8m11_lookup{
		build_bitmask_for<8, 11>() };
	...
	{
		// -2 to normalize popcount 2,48 to index 0,46
		return pop_count(number & outer_48_bits_mask) - 2;
	}
	...
	__forceinline void set_lookup_ptrs(
		...
		const uint8_t*& lookup_7_ptr)
	{
		...
		if constexpr (pass == 1)
		{
			...
			constexpr uint64_t bitmask{ bitmask_for<3, 5> };
			static_assert(bitmask == bitmask_for<4, 17>);
			static_assert(bitmask == bitmask_for<5, 13>);
			static_assert(bitmask == bitmask_for<8, 13>);
			static_assert(bitmask == bitmask_for<13, 17>);
			static_assert(period_of<bitmask> == 4);

			const size_t pc_0 = pop_count(
				next_number & (bitmask << 0) & outer_48_bits_mask);
			size_t b3_sum = pc_0;
			size_t b4_sum = pc_0;
			size_t b5_sum = pc_0;
			size_t b8_sum = pc_0;
			size_t b13_sum = pc_0;
			const size_t pc_1 = pop_count(
				next_number & (bitmask << 1) & outer_48_bits_mask);
			b3_sum += pc_1 * pow_mod(3, 1, 5);
			b4_sum += pc_1 * pow_mod(4, 1, 17);
			b5_sum += pc_1 * pow_mod(5, 1, 13);
			b8_sum += pc_1 * pow_mod(8, 1, 13);
			b13_sum += pc_1 * pow_mod(13, 1, 17);
			const size_t pc_2 = pop_count(
				next_number & (bitmask << 2) & outer_48_bits_mask);
			b3_sum += pc_2 * pow_mod(3, 2, 5);
			b4_sum += pc_2 * pow_mod(4, 2, 17);
			b5_sum += pc_2 * pow_mod(5, 2, 13);
			b8_sum += pc_2 * pow_mod(8, 2, 13);
			b13_sum += pc_2 * pow_mod(13, 2, 17);
			const size_t pc_3 = pop_count(
				next_number & (bitmask << 3) & outer_48_bits_mask);
			b3_sum += pc_3 * pow_mod(3, 3, 5);
			b4_sum += pc_3 * pow_mod(4, 3, 17);
			b5_sum += pc_3 * pow_mod(5, 3, 13);
		...
		{
			{
				constexpr uint64_t bitmask{ bitmask_for<3, 13> };
				static_assert(bitmask == bitmask_for<4, 7>);
				static_assert(bitmask == bitmask_for<9, 13>);
				...
				const size_t pc_1 = pop_count(
					next_number & (bitmask << 1) & outer_48_bits_mask);
				b3_sum += pc_1 * pow_mod(3, 1, 13);
				b4_sum += pc_1 * pow_mod(4, 1, 7);
				b9_sum += pc_1 * pow_mod(9, 1, 13);
				const size_t pc_2 = pop_count(
					next_number & (bitmask << 2) & outer_48_bits_mask);
			...
			{
				constexpr uint64_t bitmask{ bitmask_for<3, 7> };
				static_assert(bitmask == bitmask_for<4, 13>);
				static_assert(bitmask == bitmask_for<5, 7>);
				static_assert(bitmask == bitmask_for<10, 13>);
				...
				const size_t pc_1 = pop_count(
					next_number & (bitmask << 1) & outer_48_bits_mask);
				b3_sum += pc_1 * pow_mod(3, 1, 7);
				b4_sum += pc_1 * pow_mod(4, 1, 13);
				b5_sum += pc_1 * pow_mod(5, 1, 7);
				b10_sum += pc_1 * pow_mod(10, 1, 13);
				const size_t pc_2 = pop_count(
					next_number & (bitmask << 2) & outer_48_bits_mask);
				b3_sum += pc_2 * pow_mod(3, 2, 7);
				b4_sum += pc_2 * pow_mod(4, 2, 13);
				b5_sum += pc_2 * pow_mod(5, 2, 7);
				b10_sum += pc_2 * pow_mod(10, 2, 13);
				const size_t pc_3 = pop_count(
					next_number & (bitmask << 3) & outer_48_bits_mask);
				b3_sum += pc_3 * pow_mod(3, 3, 7);
				b4_sum += pc_3 * pow_mod(4, 3, 13);
				b5_sum += pc_3 * pow_mod(5, 3, 7);
				b10_sum += pc_3 * pow_mod(10, 3, 13);
				const size_t pc_4 = pop_count(
					next_number & (bitmask << 4) & outer_48_bits_mask);
				b3_sum += pc_4 * pow_mod(3, 4, 7);
				b4_sum += pc_4 * pow_mod(4, 4, 13);
				b5_sum += pc_4 * pow_mod(5, 4, 7);
				b10_sum += pc_4 * pow_mod(10, 4, 13);
				const size_t pc_5 = pop_count(
					next_number & (bitmask << 5) & outer_48_bits_mask);
				b3_sum += pc_5 * pow_mod(3, 5, 7);
				b4_sum += pc_5 * pow_mod(4, 5, 13);
		...
		{
			{
				constexpr uint64_t bitmask{ bitmask_for<3, 11> };
				static_assert(bitmask == bitmask_for<4, 11>);
				static_assert(bitmask == bitmask_for<5, 11>);
				static_assert(bitmask == bitmask_for<9, 11>);
				...
				const size_t pc_1 = pop_count(
					next_number & (bitmask << 1) & outer_48_bits_mask);
				b3_sum += pc_1 * pow_mod(3, 1, 11);
				b4_sum += pc_1 * pow_mod(4, 1, 11);
				b5_sum += pc_1 * pow_mod(5, 1, 11);
				b9_sum += pc_1 * pow_mod(9, 1, 11);
				const size_t pc_2 = pop_count(
					next_number & (bitmask << 2) & outer_48_bits_mask);
				b3_sum += pc_2 * pow_mod(3, 2, 11);
				b4_sum += pc_2 * pow_mod(4, 2, 11);
				b5_sum += pc_2 * pow_mod(5, 2, 11);
				b9_sum += pc_2 * pow_mod(9, 2, 11);
				const size_t pc_3 = pop_count(
					next_number & (bitmask << 3) & outer_48_bits_mask);
				b3_sum += pc_3 * pow_mod(3, 3, 11);
				b4_sum += pc_3 * pow_mod(4, 3, 11);
				b5_sum += pc_3 * pow_mod(5, 3, 11);
				b9_sum += pc_3 * pow_mod(9, 3, 11);
				const size_t pc_4 = pop_count(
					next_number & (bitmask << 4) & outer_48_bits_mask);
				b3_sum += pc_4 * pow_mod(3, 4, 11);
			...
			{
				constexpr uint64_t bitmask{ bitmask_for<6, 11> };
				static_assert(bitmask == bitmask_for<7, 11>);
				static_assert(bitmask == bitmask_for<8, 11>);
				...
				const size_t pc_1 = pop_count(
					next_number & (bitmask << 1) & outer_48_bits_mask);
				b6_sum += pc_1 * pow_mod(6, 1, 11);
				b7_sum += pc_1 * pow_mod(7, 1, 11);
				b8_sum += pc_1 * pow_mod(8, 1, 11);
				const size_t pc_2 = pop_count(
					next_number & (bitmask << 2) & outer_48_bits_mask);
				b6_sum += pc_2 * pow_mod(6, 2, 11);
				b7_sum += pc_2 * pow_mod(7, 2, 11);
				b8_sum += pc_2 * pow_mod(8, 2, 11);
				const size_t pc_3 = pop_count(
					next_number & (bitmask << 3) & outer_48_bits_mask);
				b6_sum += pc_3 * pow_mod(6, 3, 11);
				b7_sum += pc_3 * pow_mod(7, 3, 11);
				b8_sum += pc_3 * pow_mod(8, 3, 11);
				const size_t pc_4 = pop_count(
					next_number & (bitmask << 4) & outer_48_bits_mask);
				b6_sum += pc_4 * pow_mod(6, 4, 11);
				b7_sum += pc_4 * pow_mod(7, 4, 11);
				b8_sum += pc_4 * pow_mod(8, 4, 11);
				const size_t pc_5 = pop_count(
					next_number & (bitmask << 5) & outer_48_bits_mask);
				b6_sum += pc_5 * pow_mod(6, 5, 11);
				b7_sum += pc_5 * pow_mod(7, 5, 11);
				b8_sum += pc_5 * pow_mod(8, 5, 11);
				const size_t pc_6 = pop_count(
					next_number & (bitmask << 6) & outer_48_bits_mask);
				b6_sum += pc_6 * pow_mod(6, 6, 11);
				b7_sum += pc_6 * pow_mod(7, 6, 11);
				b8_sum += pc_6 * pow_mod(8, 6, 11);
				const size_t pc_7 = pop_count(
					next_number & (bitmask << 7) & outer_48_bits_mask);
				b6_sum += pc_7 * pow_mod(6, 7, 11);
				b7_sum += pc_7 * pow_mod(7, 7, 11);
				b8_sum += pc_7 * pow_mod(8, 7, 11);
				const size_t pc_8 = pop_count(
					next_number & (bitmask << 8) & outer_48_bits_mask);
				b6_sum += pc_8 * pow_mod(6, 8, 11);
				b7_sum += pc_8 * pow_mod(7, 8, 11);
				b8_sum += pc_8 * pow_mod(8, 8, 11);
				const size_t pc_9 = pop_count(
					next_number & (bitmask << 9) & outer_48_bits_mask);
				b6_sum += pc_9 * pow_mod(6, 9, 11);
				b7_sum += pc_9 * pow_mod(7, 9, 11);
				b8_sum += pc_9 * pow_mod(8, 9, 11);

				lookup_5_ptr = (*b6m11_lookup)[b6_sum % 11].data() + byte_offset;
				lookup_6_ptr = (*b7m11_lookup)[b7_sum % 11].data() + byte_offset;
				lookup_7_ptr = (*b8m11_lookup)[b8_sum % 11].data() + byte_offset;
			}
		}
	}
	...
	{
		const size_t elements_to_rollover{
			(pow_2_16 - ((number & bits_1_16_mask) >> 1)) % pow_2_16 }; // map 65,536 -> 0

		uint64_t block{ *(uint64_t*)in };
		const uint64_t mask{
			*(uint64_t*)lookup_1_ptr &
		...
		{
			set_lookup_ptrs<pass>(
				number + (elements_to_rollover * 2),
				lookup_1_ptr,
				lookup_2_ptr,
				lookup_3_ptr,
				lookup_4_ptr,
			...
			const uint64_t select_from_old{
				(1ull << elements_to_rollover) - 1 }; // up to and including rollover
			const uint64_t select_from_new{ ~select_from_old };

			block &= (
				(mask & select_from_old) |
				(new_mask & select_from_new));

			// (re)set
			set_lookup_ptrs<pass>(number + (64ull * 2),
				lookup_1_ptr,
				lookup_2_ptr,
				lookup_3_ptr,
				lookup_4_ptr,
	...
	{
		static constexpr uint8_t static_pc_shuf_lookup[32]{
			0, 1, 1, 2, 1, 2, 2, 3, 1, 2, 2, 3, 2, 3, 3, 4,
			0, 1, 1, 2, 1, 2, 2, 3, 1, 2, 2, 3, 2, 3, 3, 4 };
		static constexpr uint64_t static_nybble_mask[4]{
		...
		const uint8_t* const aligned_end{
			out + ((sieve_container::size() / 256) * bytes_per_step) };
		...
		for (; out != aligned_end; )
		{
			...
			const size_t n_steps{ std::min(
				elements_to_rollover / elements_per_step,
				...
				offset += bytes_per_step)
			{
				...
				{
					constexpr size_t prefetch_offset{ 64ull * 2 };
				...
				const uint256_t merged_data = _mm256_and_si256(
					_mm256_and_si256(m1, m2),
				...
				if constexpr (pass >= popcount_from_pass)
				{
					...
					const uint256_t nybbles_hi = _mm256_and_si256(
						_mm256_srli_epi64(merged_data, 4), nybble_mask);
					// nybbles -> 8-bit pcs
					uint256_t pc_256 = _mm256_add_epi8(
						_mm256_shuffle_epi8(pc_shuf_lookup, nybbles_lo),
